      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        {activeTab === 'winners' && (
          <>
            {winners.length === 0 ? (
              <div className="bg-gray-900 rounded-2xl p-6 border border-gray-800">
                <p className="text-gray-500 text-sm">No winners yet. Run and publish a draw first.</p>
              </div>
            ) : (
              <>
                              ...
                              {w.proof_url ? (
                                <>
                                  ...
                                  <button
                                    ...
                                    className="text-xs bg-green-500/20 text-green-400 px-3 py-1 rounded-full border border-green-500/30 hover:bg-green-500/30">
                                    ✓ Approve
                                  </button>
                                  <button
                                    onClick={() => handleVerification(w.id, 'rejected')}
                                    className="text-xs bg-red-500/20 text-red-400 px-3 py-1 rounded-full border border-red-500/30 hover:bg-red-500/30">
                                    ✕ Reject
                                  </button>
                                </>
                              ) : (
                        ...
                        <div key={w.id}
                          ...
                          <div>
                            ...
                            <p className="text-gray-500 text-xs">
                              {w.draws?.draw_month} · {w.match_type}
                            </p>
                          </div>
